...
// 标题
const title = 'Dolphin: Efficient Audio-Visual Speech Separation with Discrete Lip Semantics and Multi-Scale Global-Local Attention'
...
// 强调内容
const emphases = [
  "🎯 Over 50% Fewer Parameters: Achieves superior performance with remarkable parameter efficiency",
  "⚡ Over 6× Faster Inference: Dramatically accelerates GPU inference speed for real-world deployment", 
  "🧠 DP-LipCoder: Transforms lip-motion into audio-aligned discrete semantic tokens",
  "🔄 Global-Local Attention: Single-iteration design with multi-scale dependency modeling",
]
...
const buttons = [
  {
    disabled: false,
    name: "💻 Code",
    link: "https://github.com/Dolphin-AVSS/Dolphin/",
    component: Files,
  },
]
